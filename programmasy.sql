...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2023 a las 20:31:56
...
INSERT INTO `usuarios` (`UsserID`, `UsserName`, `Email`, `Password`, `StatusID`, `MatricID`, `RegistrarID`) VALUES
(1, 'ruben', 'morilloruben663@gmail.com', '123456', NULL, NULL, NULL),
(2, 'alexis', 'yahami663natsuo@gmail.com', 'radm663duran', NULL, NULL, NULL);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_AStatus` (`StatusID`),
  ADD KEY `fk_ARegistrar` (`RegistrarID`),
  ADD KEY `fk_AMatric` (`MatricID`);
...
--
ALTER TABLE `usuarios`
  MODIFY `UsserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_AMatric` FOREIGN KEY (`MatricID`) REFERENCES `matriculados` (`MatricID`),
  ADD CONSTRAINT `fk_ARegistrar` FOREIGN KEY (`RegistrarID`) REFERENCES `registro` (`RegistrarID`),
  ADD CONSTRAINT `fk_AStatus` FOREIGN KEY (`StatusID`) REFERENCES `estados` (`StatusID`);
COMMIT;
